...
public class Window extends FrameLayout {
	...
	public Window(final StandOutWindow context, final int id) {
        ...
        mGestureDetector = new GestureDetector(mContext,new GestureHandler());
		...
		RelativeLayout body;
			...
			body = (RelativeLayout) content.findViewById(R.id.host_widget);
	...
	private View getSystemDecorations() {
        ...
        View decorations = mLayoutInflater.inflate(
    ...
    private class GestureHandler extends GestureDetector.SimpleOnGestureListener
    {
        ...
        public boolean onDoubleTap(MotionEvent e) {
            return mContext.onDoubleTap(id,Window.this,e);
        }

        @Override
        public void onLongPress(MotionEvent e) {
            mContext.onDoubleTap(id,Window.this,e);
        }
    }
