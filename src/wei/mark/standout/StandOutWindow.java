...
public abstract class StandOutWindow extends Service {
	...
	/**
	 * Intent action: ButtonBar an existing window with an existing id.
	 */
	public static final String ACTION_CLOSE = "CLOSE";

	/**
	 * Intent action: ButtonBar all existing windows.
	 */
	...
	/**
	 * ButtonBar an existing window with an existing id.
	 * 
	 * @param context
	 *            A Context of the application package implementing this class.
	 * @param cls
	...
	/**
	 * ButtonBar all existing windows.
	 * 
	 * @param context
	 *            A Context of the application package implementing this class.
	 * @param cls
	 ...
	 * 
	 * <p>
	 * Send {@link android.os.Parceleable} data in a {@link android.os.Bundle} to a new or existing
	...
	/**
	 * See {@link #closeAll(android.content.Context, Class)} eAll(android.content.Context, Class, int)}.
	 * 
	 * @param context
	 *            A Context of the application package implementing this class.
	 * @param cls
	 ...
	 * @param frame
	 *            The {@link android.widget.FrameLayout} to attach your view as a child to.
	 */
	public abstract void createAndAttachView(int id, FrameLayout frame);

    public abstract void createAndAttachView(int id, RelativeLayout relativeLayout);
	/**
	 ...
	 * test if a flag is set, use {@link wei.mark.standout.Utils#isSet(int, int)}.
	 * 
	 * @param id
	 *            The id of the window.
    ...
    public StandOutWindow getStandOutContext()
    {
        return this;
    }
	...
	/**
	 * ButtonBar a window corresponding to the id.
	 * 
	 * @param id
	 *            The id of the window.
	 */
		...
		try {
			...
			if (animation != null) {
				...
				if (sWindowCache.getCacheSize(getClass()) == 0) {
					...
					startedForeground = false;
					//stopForeground(true);
                    //TODO Removed foreground callback
				}
	...
	/**
	 * Send  data in a {@link android.os.Bundle} to a new or existing
	 * windows. The implementation of the recipient window can handle what to do
