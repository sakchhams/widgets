...
public class StandOutFlags {
	 ...
	 * {@link StandOutWindow#onTouchHandleResize(int, wei.mark.standout.ui.Window, android.view.View, android.view.MotionEvent)}
	 * . The aspect ratio will not be enforced if you set the width or height of
	 * the window's LayoutParams manually.
	 * 
	 * @see StandOutWindow#onTouchHandleResize(int, wei.mark.standout.ui.Window, android.view.View, android.view.MotionEvent)
	 */
	 ...
	 * 
	 * @see wei.mark.standout.ui.Window#onInterceptTouchEvent(android.view.MotionEvent)
	 */
	 ...
	 * {@link StandOutWindow#onFocusChange(int, wei.mark.standout.ui.Window, boolean)}.
	 * 
	 * @see {@link wei.mark.standout.ui.Window#onFocus(boolean)}
	 * 
	 */
